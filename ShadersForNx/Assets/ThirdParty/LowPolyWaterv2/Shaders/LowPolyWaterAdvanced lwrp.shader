Shader "LowPolyWater/Advanced LWRP" {
...
SubShader {
	Tags { "RenderType"="Transparent" "IgnoreProjector"="True" "Queue"="AlphaTest+51" "RenderPipeline" = "LightweightPipeline" "LightMode"="LightweightForward"}
	LOD 200
	ZWrite [_ZWrite]
	Cull [_Cull_]
